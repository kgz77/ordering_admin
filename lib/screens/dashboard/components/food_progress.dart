...
List<Menu> tabs = const [
  Menu(title: 'Детали', icon: Icons.folder_copy),
  Menu(icon: Icons.photo_camera_rounded, title: 'Фото'),
  Menu(icon: Icons.monetization_on, title: 'Цена'),
  Menu(icon: Icons.summarize_outlined, title: 'Конец'),
];
