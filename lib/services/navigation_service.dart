...
import 'package:foda_admin/screens/dashboard/pages/foods/edit_food.dart';
...
import '../screens/dashboard/pages/orders/client_orders.dart';
...
class NavigationService {
  ...
  Route? onGeneratedRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case clientOrders:
        return navigateToPageRoute(settings, const ClientOrders());
      case createCategoryPath:
        return navigateToPageRoute(settings, const CreateCategoryPage());

      case editFood:
        return navigateToPageRoute(settings, const EditFoodPage());
      case createFoodPath:
